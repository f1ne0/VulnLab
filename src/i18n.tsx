...
const messages = {
  ru: {
    ...
    'home.features.report': 'Индивидуальная отчётность',
  ...
  en: {
    ...
    'home.features.report': 'Individual project reporting',
    ...
    'reports.paper': 'Individual project report',
